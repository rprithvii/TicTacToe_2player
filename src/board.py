...
class Board:
    def __init__(self):
        ...
        self.player1_indexes = []
        self.player2_indexes = []
    ...
    def check_winner(self):
        a = set(self.player1_indexes)
        b = set(self.player2_indexes)
